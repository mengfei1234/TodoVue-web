  ...
  import TodoFooter from './components/TodoFooter'
    export default {
        ...
        data(){
          return{
            todos:[
              {title:'我爱吃',complete:false},
              {title:'我爱吃土豆',complete:true},
              {title:'我爱吃土豆饼',complete:false},
            ]
          }
        },
        methods:{
...
<style scoped>
    .todo-container-all{
        background:url('../src-comments/assets/one.jpg') no-repeat center;
    }
  .todo-container {
    width: 55vw;
    margin: 0 auto;
